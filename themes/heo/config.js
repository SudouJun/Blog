const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '访问酥逗菌の星辰海', url: 'https://www.sudoujun.com' }
  ],
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '网站公告', url: '/tag/网站公告' },
  ...
  HEO_INFO_CARD_URL2: 'https://space.bilibili.com/236467610',
  HEO_INFO_CARD_ICON2: 'fa-brands fa-bilibili',
  HEO_INFO_CARD_URL3: 'https://www.sudoujun.com',
  HEO_INFO_CARD_TEXT3: '我的主站',
